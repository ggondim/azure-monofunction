...
class AzureMonofunction {
  ...
  /* 
   * OPTIONS is not encouraged as a shorthand method because Azure Functions
   * intercepts this verb and return supported methods configured in
   * function.json
  */

  /* 
   * HEAD also is not encouraged as a shorthand method because it only serves
   * for returning HTTP headers for the request.
  */
}
